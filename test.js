...
function checkForMatch() {
    const cards = document.querySelectorAll('img:not([id=logo])');
    ...
    if (cardChosen[0].name === cardChosen[1].name) {
        cards[selectedCardOne].setAttribute('src' , 'transparent.png');
        cards[selectedCardTwo].setAttribute('src' , 'transparent.png');
        score = score + 1;
